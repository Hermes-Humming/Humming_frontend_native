          ...
          <CardView style={styles.card}>
            ...
            <View style={{ padding: 20 }}>
              {tempData[postId] === (null || undefined) ? (
                ...
                <View>
                  <Text style={styles.sectionSubtitle}>{tempData[postId].subtitle}</Text>
                  <Text style={styles.sectionTitle}>{tempData[postId].title}</Text>
                  <Text style={styles.sectionContent}>{tempData[postId].content}</Text>
                </View>
              )}
            </View>
          </CardView>
